// Single file which contains all libraries in use

// Note: libraries can not inherit from other libraries
// See: http://solidity.readthedocs.org/en/latest/contracts.html#libraries
